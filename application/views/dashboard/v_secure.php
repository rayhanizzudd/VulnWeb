    ...
    <div class="row">
      ...
      <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Selamat datang di halaman Secure web, <strong><?php echo ucfirst($this->session->userdata('username')); ?></strong>!</h1>
        </div>
           <p>Pada halaman Secure ini anda akan diberikan tampilan website yang menyerupai website sebenarnya namum dilengkapi dengan keamanan, sehingga dengan adanya vulnweb ini anda bisa mengetahui dan mencoba unutuk testing pada fitur yang tersedia pada website pada umumnya.</p>
